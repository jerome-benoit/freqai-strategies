...
| freqai.extrema_weighting.normalization               | `minmax`          | enum {`minmax`,`l1`,`none`}                                                                                                      | Normalization method for weights (minmax scales to [0,1], l1 sums to 1, none preserves values).                                                                                                            |
