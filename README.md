...
| freqai.extrema_smoothing.window                      | 5                 | int >= 1                                                                                                                         | Window size for extrema smoothing.                                                                                                                                                                         |
| freqai.extrema_smoothing.beta                        | 8.0               | float > 0                                                                                                                        | Kaiser kernel shape parameter.                                                                                                                                                                             |
| _Extrema weighting_                                  |                   |                                                                                                                                  |                                                                                                                                                                                                            |
| freqai.extrema_weighting.strategy                    | `none`            | enum {`none`,`pivot_threshold`}                                                                                                  | Pondération appliquée avant lissage, basé sur valeurs de seuil pivots Zigzag.                                                                                                                              |
| freqai.extrema_weighting.normalization               | `minmax`          | enum {`minmax`,`l1`,`none`}                                                                                                      | Méthode de normalisation des poids dérivés des seuils (minmax échelle [0,1], l1 somme=1, none conserve valeurs brutes).                                                                                    |
| freqai.extrema_weighting.gamma                       | 1.0               | float (0,10]                                                                                                                     | Exposant de contraste appliqué après normalisation ( >1 accentue extrêmes, 0<gamma<1 adoucit).                                                                                                             |
