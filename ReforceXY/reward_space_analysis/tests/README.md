...
| pbrs-canonical-verified-report-116          | pbrs        | Canonical trajectories with valid evidence classified as verified                    | pbrs/test_pbrs.py            | test_pbrs_canonical_near_zero_report                                                                        |
...
| helpers-transitions-preserve-multiplicity-108 | helpers    | Repeated transitions retained; no value-based dedup                                                | helpers/test_utilities.py            | test_repeated_transitions_preserve_multiplicity                                                              |
...
| statistics-independence-contract-123         | statistics  | Inference helpers require explicit independent_observations=True                    | statistics/test_statistics.py            | TypeError/ValueError refusals in test_bootstrap_rejects_invalid_bounds helpers                               |
| report-independent-sections-124              | integration | CI/diagnostics/shift sections independent of hypothesis tests; actual resample count | integration/test_report_formatting.py:28 | test_statistical_sections_do_not_depend_on_hypothesis_tests                                                 |
| pbrs-discounted-evidence-125                 | pbrs        | Verification from local identity, continuity, discounted boundary; else not verified | pbrs/test_pbrs.py            | test_pbrs_canonical_discontinuous_potentials_report                                                          |
