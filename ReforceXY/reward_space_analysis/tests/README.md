...
| pbrs-unified-fee-primitives-122               | pbrs        | Native spot LocalTrade mirror uses unified entry/exit fee formulas for long and short | pbrs/test_pbrs.py:599                     | Covers the exact native analytical formulas for both directions                                             |
