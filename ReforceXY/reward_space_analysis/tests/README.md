...
| pbrs-unified-fee-primitives-122               | pbrs        | Native spot LocalTrade mirror uses FtPrecise-equivalent fee staging for long and short | pbrs/test_pbrs.py:599                     | Covers friendly values and native eight-decimal rounding boundaries for both directions                     |
