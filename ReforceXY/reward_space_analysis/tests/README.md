...
| pbrs-canonical-verified-report-116            | pbrs        | Canonical trajectories with valid evidence are classified as verified                | pbrs/test_pbrs.py:1378                    | Requires local identity, potential continuity, discounted terminal boundary, and zero observed additives    |
