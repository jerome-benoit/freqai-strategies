...
def compute_label_weights(
    ...
    *,
    ...
    ValueError otherwise. ``finite_gaussian_support`` truncates Gaussian
    fills to the radius tracked by causal availability.
    """
...
def weight_fill_radius(weighting_config: dict[str, Any]) -> int:
    ...
    generation. The additive epsilon floor is a global O(fill_epsilon) term,
    left unconstrained (negligible).
    """
    label_weighting = {**DEFAULTS_LABEL_WEIGHTING, **weighting_config}
